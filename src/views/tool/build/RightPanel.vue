<template>
  <div class="right-board">
    ...
    <div class="field-box">
      <a class="document-link" target="_blank" :href="documentLink" title="查看組件文檔">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.vModel!==undefined" label="字段名">
            <el-input v-model="activeData.vModel" placeholder="請輸入字段名（v-model）" />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.vModel!==undefined" label="默認值">
            <el-input
          ...
          <el-form-item v-if="activeData.maxlength !== undefined" label="最多輸入">
            <el-input v-model="activeData.maxlength" placeholder="請輸入字符長度">
          ...
          <el-form-item v-if="activeData.name !== undefined" label="文件字段名">
            <el-input v-model="activeData.name" placeholder="請輸入上傳文件字段名" />
          </el-form-item>
